...
def get_dataset(dataset_name, cfg):
    if dataset_name == 'GrabCut':
        ...
        dataset = BerkeleyDataset(cfg.SPLEEN_PATH)
    elif dataset_name == 'lung':
        dataset = BerkeleyDataset(cfg.LUNG_PATH)
    elif dataset_name == 'liver':
        dataset = BerkeleyDataset(cfg.LIVER_PATH)
    elif dataset_name == 'heart':
        dataset = BerkeleyDataset(cfg.HEART_PATH)
    elif dataset_name == 'colon':
        dataset = BerkeleyDataset(cfg.COLON_PATH)
    elif dataset_name == 'pancreas':
        dataset = BerkeleyDataset(cfg.PANCREAS_PATH)
    elif dataset_name == 'spleen_ventaneo':
        dataset = BerkeleyDataset(cfg.SPLEEN_VENTANEO_PATH)
    elif dataset_name == 'spleen_ventaneo_mediana':
        dataset = BerkeleyDataset(cfg.SPLEEN_VENTANEO_MEDIANA_PATH)
    elif dataset_name == 'lung_ventaneo':
        dataset = BerkeleyDataset(cfg.LUNG_VENTANEO_PATH)
    elif dataset_name == 'lung_ventaneo_mediana':
        dataset = BerkeleyDataset(cfg.LUNG_VENTANEO_MEDIANA_PATH)
    elif dataset_name == 'liver_ventaneo':
            dataset = BerkeleyDataset(cfg.LIVER_VENTANEO_PATH)
    elif dataset_name == 'liver_ventaneo_mediana':
            dataset = BerkeleyDataset(cfg.LIVER_VENTANEO_MEDIANA_PATH)
    elif dataset_name == 'pancreas_ventaneo':
        dataset = BerkeleyDataset(cfg.PANCREAS_VENTANEO_PATH)
    elif dataset_name == 'pancreas_ventaneo_mediana':
        dataset = BerkeleyDataset(cfg.PANCREAS_VENTANEO_MEDIANA_PATH)
    elif dataset_name == 'colon_ventaneo':
        dataset = BerkeleyDataset(cfg.COLON_VENTANEO_PATH)
    elif dataset_name == 'colon_ventaneo_mediana':
        dataset = BerkeleyDataset(cfg.COLON_VENTANEO_MEDIANA_PATH)
    elif dataset_name == 'heart_ventaneo':
        dataset = BerkeleyDataset(cfg.HEART_VENTANEO_PATH)
    elif dataset_name == 'heart_ventaneo_mediana':
        dataset = BerkeleyDataset(cfg.HEART_VENTANEO_MEDIANA_PATH)        
